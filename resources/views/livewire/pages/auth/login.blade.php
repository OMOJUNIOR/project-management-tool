...
<div>
    ...
    <div class="flex justify-end mb-2">
        <a href="{{ route('register') }}" wire:navigate class="text-sm text-gray-600 underline rounded-md dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
            {{ __('Register') }}
        </a>
    </div>
